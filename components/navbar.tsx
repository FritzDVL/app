    ...
    <nav className="sticky top-0 z-50 border-b border-slate-200/60 bg-white/80 px-4 py-3 shadow-xl shadow-slate-200/20 backdrop-blur-md">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <Link href="/" className="group flex items-center space-x-2">
          <div className="flex h-8 w-8 items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:drop-shadow-lg">
            <Image
              src="/logo.png"
              alt="LensForum Logo"
              width={32}
              height={32}
              className="rounded-lg shadow-sm transition-all duration-300 group-hover:shadow-md group-hover:shadow-brand-200/50"
            />
          </div>
