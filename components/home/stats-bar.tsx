...
export function StatsBar({ loadingStats, statsError, forumStats }: StatsBarProps) {
  return (
    <div className="mb-8 grid grid-cols-2 gap-4 sm:grid-cols-3">
      <div className="group cursor-pointer rounded-2xl border border-border p-4 backdrop-blur-sm transition-all hover:scale-105 hover:border-primary/60 dark:bg-gray-800">
      ...
      <div className="group cursor-pointer rounded-2xl border border-border p-4 backdrop-blur-sm transition-all hover:scale-105 hover:border-green-300/60 dark:bg-gray-800">
        <div className="flex flex-col items-center text-center">
      ...
      <div className="group cursor-pointer rounded-2xl border border-border p-4 backdrop-blur-sm transition-all hover:scale-105 hover:border-amber-300/60 dark:bg-gray-800">
        <div className="flex flex-col items-center text-center">
