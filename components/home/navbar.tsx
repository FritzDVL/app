    ...
    <nav className="sticky top-0 z-50 border-b border-slate-200/60 bg-white/80 px-4 py-3 shadow-xl shadow-slate-200/20 backdrop-blur-md">
      ...
      <div className="mb-2 w-full rounded-lg border border-yellow-300 bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-50 px-4 py-2 text-center text-sm font-semibold text-yellow-900 shadow-sm">
        ...
        <span>
          ...
          All data, posts, and accounts may be <span className="font-bold text-yellow-700">reset or deleted</span> at
          any time. Enjoy exploring, but don&apos;t get too attached!
        </span>
      </div>
