...
export function HeroSection() {
  return (
    <section className="homepage-hero mb-16 text-center">
      <div className="homepage-powered mb-6 inline-flex items-center rounded-full border border-brand-200/60 bg-brand-50/80 px-4 py-2 text-sm font-medium text-brand-700 backdrop-blur-sm">
      ...
      <p className="homepage-description mx-auto mb-8 max-w-2xl text-xl leading-relaxed text-slate-600">
      ...
      <div className="homepage-cta flex justify-center">
        <Link href="/communities">
          <Button
            variant="outline"
            className="homepage-cta-btn rounded-full border-slate-300 px-8 py-3 text-lg font-medium text-slate-700 hover:bg-slate-50"
          >
            Explore Communities
          </Button>
        </Link>
